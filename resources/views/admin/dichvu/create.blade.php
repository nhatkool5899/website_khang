...
@section('content')
    <h4 class="font-medium leading-tight text-2xl mt-0 mb-2">Thêm dịch vụ mới</h4>
    ...
    <form action="{{route('service.store')}}" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3 form-group">
        ...
        <textarea name="content" id="ckeditor" class="form-control" rows="10">{{old('content')}}</textarea>
    </div>
        <div class="mb-3 form-group">
