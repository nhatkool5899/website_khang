...
@section('content')
    ...
    @endif
    <form action="{{url('lien-he/update')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" class="form-control" name="title" value="{{$lienhe->title}}">
        </div>
        <div class="mb-3 form-group">
            <label class="form-label">Nội dung</label>
            <textarea name="content" id="ckeditor" class="form-control" rows="10">{{$lienhe->content}}</textarea>
        </div>
