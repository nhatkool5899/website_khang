...
@section('content')
    ...
    @endif
    <form action="{{route('collected.update', ['collected' => $collected->id])}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3 form-group">
            ...
            <div class="list-img">
                <label for="inputImg1" class="form-label custom-label">
                    <img class="imgPreview1" src="{{asset('uploads/bo-suu-tap/'.$collected->layout->img_1)}}" alt="">
                    <span>Ảnh 1</span>
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" class="form-control" name="name" value="{{$collected->name}}">
        </div>
        <div class="mb-3 form-group">
            <label class="form-label">Mô tả</label>
            <textarea name="description" class="form-control" id="ckeditor" rows="10">{{$collected->description}}</textarea>
        </div>
