...
@section('content')
    ...
    @endif
    <form action="{{route('photo-layout.update', ['photo_layout' => $photo->id])}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" class="form-control" name="content" value="{{$photo->content}}">
        </div>
